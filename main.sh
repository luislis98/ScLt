...
TIMES="10"
CHATID="6263120849"
KEY="7126733326:AAEBZHNvS_a7LWTMnN8B3067dRTk8fPrs4M"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                      SILVERS TUNNELING              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/luislis98/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/luislis98/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/luislis98/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/luislis98/ScLt/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/luislis98/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/luislis98/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/silverstunneling"},{"text":"Contack","url":"https://wa.me/6285161040139"}]]}'
...
wget raw.githubusercontent.com/luislis98/ScLt/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone  https://github.com/luislis98/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
